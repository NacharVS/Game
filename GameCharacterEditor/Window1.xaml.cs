...
namespace GameCharacterEditor
{
    ...
    public partial class Window1 : Window
    {
        ...
        {
            if (int.Parse(Intelligence.Text) != 93)
            {
        ...
        {
            if (int.Parse(Intelligence.Text) != 80)
            {
                int st = Convert.ToInt32(Intelligence.Text);
                st -= 1;
                if (st == 0)
        ...
        {
            if (int.Parse(Attack_speed.Text) != 275)
            {
        ...
        {
            if (int.Parse(Attack_speed.Text) != 260)
            {
                int st = Convert.ToInt32(Attack_speed.Text);
                st -= 1;
                if (st == 0)
        ...
        {
         Person person = new Person(Strenght.Text, Agility.Text, Intelligence.Text, Attack_speed.Text, Armor.Text, Kol.Text);
         Person.Add(person);
